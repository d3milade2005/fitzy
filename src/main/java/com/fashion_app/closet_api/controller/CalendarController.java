...
public class CalendarController {
    ...
    // coming soon: move this sync process to a background queue (like rabbitmq or celery) and notify the user via fcm when done so they aren't kept waiting here
    @PostMapping("/sync")
